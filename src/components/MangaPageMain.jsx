...
const MangaPageMain = (props) => {
    ...
    return (
        <section className={styles.main_content}>
            ...
            <MangaInfoItem content={data.alternativeNames} listStyle={styles.list} titleStyle={styles.list_title}/>
            <MangaInfoItem title={"Жанри"} content={data.genres} listStyle={styles.list} itemStyle={styles.item} titleStyle={styles.list_title}/>
